<template>
  <div>
    ...
    <EventCard nameEvent="sad" description="des" registerEnd="12/12/1220" point="120" img="https://m.media-amazon.com/images/M/MV5BNmMwNzNmZDEtOGU0NC00MDQ3LWJkMDItYjdhYmQyNjM4NGFlXkEyXkFqcGdeQXVyODk4OTc3MTY@._V1_.jpg"
    />
    <!-- DISPLAY EVENT LIST -->
    <!-- <section class="event-list px-4"> -->
    <!-- <div v-if="menuType === `ALL_EVENT`">
        <div v-for="event in eventListData" :key="event.id">
          <EventCard
            :img="event.img"
            :name="event.name"
            ...
            :tags="event.tags"v
            class="mt-3"
            @click="this.$router.push(`/event/${event._id}`)"
          />
        </div>
      </div> -->
    <!-- <div v-else>
